...
exports.sleep = exports.removeVersionFromPackageName = exports.mangleScopedPackage = exports.unmangleScopedPackage = exports.isScopedPackage = exports.computeHash = exports.withoutStart = exports.identity = exports.parseJson = void 0;
...
function removeVersionFromPackageName(packageName) {
    return packageName === null || packageName === void 0 ? void 0 : packageName.replace(/\/v(\d){1,}$/i, "");
}
